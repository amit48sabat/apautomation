...
import com.incture.accpay.ecm.ECMSingleton;

/**
 * Servlet connecting to the document store service in SAP Cloud Platform (requires authentication).
 */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
           ...
           // connectToEcm(request, response);
        	openCmisSession = ECMSingleton.getConnection();
