...
@Entity
@Table(name = "AP_INVOICE_LINE_ITEMS_HISTORY")
public class InvoiceItemHistoryDo implements BaseDo, Serializable {
	...
	@Column(name = "INVOICE_ITEM_PARENT_ID", length = 40)
	private String invoiceItemParentId;
	...
	public String getInvoiceItemParentId() {
		return invoiceItemParentId;
	}

	public void setInvoiceItemParentId(String invoiceItemParentId) {
		this.invoiceItemParentId = invoiceItemParentId;
	}
