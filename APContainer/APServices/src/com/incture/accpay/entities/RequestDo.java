 ...
 */
@Entity
@Table(name = "AP_REQUEST")
public class RequestDo implements BaseDo, Serializable {
	...
	@Column(name = "SHOW_PLANNED_COST")
	private boolean showPlannedCost;
	
	@Column(name="VENDOR_PAYMENT_BLOCKED_DEFAULT")
	private String vendorPaymentBlockedDefault;
	
		
	@Column(name="DUPLICATE_MESSAGE")
	private String duplicateMessage;
	
	@Column(name = "GR_AVAILABLE")
	...
	public void setVendorPaymentBlockedDefault(String vendorPaymentBlockedDefault) {
