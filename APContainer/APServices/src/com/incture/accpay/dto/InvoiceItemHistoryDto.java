...
@XmlRootElement
public class InvoiceItemHistoryDto extends BaseDto implements Serializable {
	...
	public String toString() {
		return "InvoiceItemHistoryDto [VendorMaterial=" + VendorMaterial
